...
var HTMLemail = '<li class="flex-item"><span class="orange-text">email</span><span class="blue-text">%data%</span></li>';
var HTMLtwitter = '<li class="flex-item"><span class="orange-text">twitter</span><span class="blue-text">%data%</span></li>';
var HTMLgithub = '<li class="flex-item"><span class="orange-text">github</span><span class="blue-text">%data%</span></li>';
var HTMLblog = '<li class="flex-item"><span class="orange-text">blog</span><span class="blue-text">%data%</span></li>';
var HTMLlocation = '<li class="flex-item"><span class="orange-text">location</span><span class="blue-text">%data%</span></li>';
...
var HTMLprojectImage = '<img src="%data%" width = 160>';
